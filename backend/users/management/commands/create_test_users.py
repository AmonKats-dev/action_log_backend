...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        pas_users = [
            ...
            {
                'username': 'ag_cpap_user',
                'password': 'agcpap123',
                'email': 'ag.cpap@example.com',
                'first_name': 'Ag.',
                'last_name': 'C/PAP',
                'employee_id': 'PAS002',
                'phone_number': '+1234567894',
                'designation': 'Ag. C/PAP',
                'department': department,
                'department_unit': DepartmentUnit.objects.get(id=2),
                'role': economist_role,
                'is_active': True
            ...
            {
                'username': 'ag_acpap_user',
                'password': 'agacpap123',
                'email': 'ag.acpap@example.com',
                'first_name': 'Ag.',
                'last_name': 'AC/PAP',
                'employee_id': 'PAS003',
                'phone_number': '+1234567895',
                'designation': 'Ag. AC/PAP',
                'department': department,
                'department_unit': DepartmentUnit.objects.get(id=2),
                'role': economist_role,
                'is_active': True
            ...
            {
                'username': 'ag_cpap_no_space',
                'password': 'agcpapns123',
                'email': 'ag.cpapns@example.com',
                'first_name': 'Ag.',
                'last_name': 'C/PAP',
                'employee_id': 'PAS004',
            ...
            {
                'username': 'ag_acpap_no_space',
                'password': 'agacpapns123',
                'email': 'ag.acpapns@example.com',
                'first_name': 'Ag.',
                'last_name': 'AC/PAP',
                'employee_id': 'PAS005',
